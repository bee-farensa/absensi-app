...
<body>
    @php
        ...
        $companyAddress = $isGlobal ? 'Semua Data Perusahaan' : ($company?->address ?? $mainOffice?->address ?? 'Alamat belum diatur.');
        ...
        <table>
            <tr>
                <td width="20%" class="text-center">
                    ...
                    @elseif(!$isGlobal)
                        <div style="width: 80px; height: 80px; background: #eee; border-radius: 50%; display: inline-block; line-height: 80px; text-align: center; font-size: 10px; color: #999; border: 1px solid #ccc;">No Logo</div>
                    @endif
                </td>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $absen->time_in ? \Carbon\Carbon::parse($absen->time_in)->format('H:i') : '-' }}</td>
                <td class="text-center">{{ $absen->time_out ? \Carbon\Carbon::parse($absen->time_out)->format('H:i') : '-' }}</td>
    ...
    <table class="signature-table">
        <tr>
            ...
            <td style="width: 30%; text-align: center;">
                ...
                <span style="font-size: 10px; color: #666;">({{ $user->hasRole('super_admin') ? 'Super Admin' : 'Admin PT' }})</span></p>
            </td>
        </tr>
    </table>
